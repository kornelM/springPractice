package warsztaty.spring.ailleron.exceptions.handlers;
...
public class CustomizedExceptionResponseEntityHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity handlerUserExistsException (UserNotFoundException ex, WebRequest request){
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(), request.getDescription(false));
